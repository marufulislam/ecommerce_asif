        ...
        <div class="table-container">
          ...
          <div class="col-table-cell col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div id="cart">
              ...
              <span id="cart-total"><strong class="active-color"> <i class="icon-shopping-cart cart-quantity">&nbsp;</i></strong> item(s) -  <strong class="active-color cart-total"></strong>USD</span></button>
...
#cart-table-header,#cart-table-footer,#cart-table-footer td {
background:#f5f5f5;
}
</style>    
